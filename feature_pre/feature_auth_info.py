...
def phone_where(var):
    ...
    if (pos == 133) or (pos == 153) or (pos == 180) or (pos == 181) or (pos == 189) or (pos == 173) or (pos == 177):
        return 1
    if (pos == 130) or (pos == 131) or (pos == 132) or (pos == 155) or (pos == 156) or (pos == 185) or (pos == 186) or (
            pos == 145) or (pos == 176) or (pos == 185):
        return 2
    if (pos == 134) or (pos == 135) or (pos == 136) or (pos == 137) or (pos == 138) or (pos == 139) or (pos == 150) or (
            pos == 151) or (pos == 152) or (pos == 158) or (pos == 159) or (pos == 182) or (pos == 183) or (
            pos == 184) or (pos == 147) or (pos == 178):
        return 3
    return 4
